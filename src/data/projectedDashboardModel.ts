...
export const projectedDashboardModel: Partial<Record<PersonalProjectionKey, ProjectedDashboard>> = {
  ...
  wealth: {
    ...
    metrics: [
      ...
      { label: 'Monthly surplus', sourceCardIndex: 3, priority: 'good' },
      { label: 'Hourly value', sourceCardIndex: 4, priority: 'watch' },
    ],
    operatingRows: [
      { title: 'Net-worth scoreboard', body: 'The first read should answer what total wealth is now and what needs to be updated next.', sourceCardIndex: 0 },
      { title: 'Savings engine', body: 'Monthly surplus explains how much money is actually retained after expenses.', sourceCardIndex: 3 },
      { title: 'Real hourly value', body: 'Hourly value should use saved money divided by job and freelance hours only.', sourceCardIndex: 4 },
      { title: 'Estimate discipline', body: 'Keep source assumptions visible until monthly snapshots and hour logs are connected.', sourceCardIndex: 2 },
    ],
    evidenceRows: [
      { title: 'Current estimate', body: 'Mitchell supplied the current net-worth number for the dashboard.', sourceCardIndex: 0 },
      { title: 'Budget estimate', body: 'The expense estimate comes from Punk Records until replaced by actual trailing spend.', sourceCardIndex: 2 },
    ],
    actionRows: [
      { title: 'Enter weekly hours', body: 'Add job hours and freelance hours so the real hourly value can calculate.', sourceCardIndex: 4 },
      { title: 'Add next snapshot', body: 'Capture a monthly net-worth row to start a real trend line.', sourceCardIndex: 0 },
      { title: 'Replace estimates', body: 'Swap the budget estimate for actual trailing monthly spend when available.', sourceCardIndex: 2 },
    ],
  },
  education: {
